...
public class PageResult<T> {
    ...
    public PageResult(Long total, Integer pageNum, Integer pageSize, java.util.List<T> records) {
        this.total = total;
    ...
    public static <T> PageResult<T> of(Long total, Integer pageNum, Integer pageSize, java.util.List<T> records) {
